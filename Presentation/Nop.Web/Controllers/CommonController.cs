...
namespace Nop.Web.Controllers
{
    ...
    public partial class CommonController : BasePublicController
    {
        ...
        public virtual IActionResult ChangeLanguage()
        {
            var languages =  _languageService.GetAllLanguages(showHidden:true);
            foreach(var lang in languages)
            {
                if(lang.Id==1 || lang.Id==2)

                {
                    lang.Published = lang.Published == true ? false : true;
                    _languageService.UpdateLanguage(lang);
                }
            }
